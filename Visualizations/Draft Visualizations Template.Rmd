...
Since the p value is less than .01, then we can say that there may be a significant difference in the answers to perceived ease for requesting leave by different company size groups.  
...
Because the p value is not less than .01 we do not reject the null (there are no differences between categories). 
